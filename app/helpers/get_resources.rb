...
class GetResources
	...
	def initialize()
		...
		@photos_home = '/snowbotdev/app/config/data/photos' #On Heroku at least.
		...
		@links_home = '/snowbotdev/app/config/data/links' #On Heroku at least.
		...
		@locations_home = '/snowbotdev/app/config/data/locations' #On Heroku at least.
		...
		@playlists_home = '/snowbotdev/app/config/data/music' #On Heroku at least.
